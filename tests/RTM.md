...
| Keep file writes inside Quickshell-owned state | read-only keyless network paths and Quickshell-owned state | manifest contract and security gates | Maintainer review |
